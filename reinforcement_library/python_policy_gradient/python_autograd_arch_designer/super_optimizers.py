...
def gradient_descent(g,w,x_train,y_train,beta,alpha,max_its,batch_size,**kwargs): 
    verbose = True
    ...
    w_hist = [unflatten(w)]
    train_hist = [g_flat(w,x_train,y_train,beta,np.arange(num_train))]
    ...
    for k in range(max_its):                   
        ...
        for b in range(num_batches):
            ...
            cost_eval,grad_eval = grad(w,x_train,y_train,beta,batch_inds)
        ...
        train_cost = g_flat(w,x_train,y_train,beta,np.arange(num_train))
...
# minibatch gradient descent
def RMSprop(g,w,x_train,y_train,beta,alpha,max_its,batch_size,**kwargs): 
    verbose = True
    if 'verbose' in kwargs:
        verbose = kwargs['verbose']
